            ...
            <div className="flex flex-1 bg-slate-100">
                ...
                <div className="w-1/6 rounded-xl bg-white m-5">
                    ...
                    <ul className="p-4 grid grid-flow-row">
                        <Link href={'/dashboard/datalist'} className="m-2 text-center border rounded-full py-2 px-4">Data</Link>
                        <Link href={'/dashboard/userlist'} className="m-2 text-center bg-orange rounded-full py-2 px-4">Account</Link>
                    </ul>
                </div>
                {/* Bagian 70% */}
