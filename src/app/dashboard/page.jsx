            ...
            <div className="sm:flex ">
                ...
                <div className="inline rounded-xl bg-white md:m-2 m-0 shadow-xl">
                    ...
                    <ul className="md:p-4 p-2 grid grid-flow-row md:text-lg text-sm mt-8 w-auto justify-center">
                        <Link href={'/dashboard'} className="m-2 text-center font-medium border rounded-2xl bg-orange py-2 px-4">Data</Link>
                        <Link href={'/dashboard/userlist'} className="m-2 text-center font-medium shadow-lg rounded-2xl py-2 px-4">Account</Link>
                    </ul>
                </div>
                {/* Bagian 70% */}
