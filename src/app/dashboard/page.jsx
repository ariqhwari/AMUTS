            ...
            <div className="flex flex-1 ">
                ...
                <div className="w-1/6 rounded-xl bg-white m-4 shadow-xl">
                    ...
                    <ul className="p-4 grid grid-flow-row">
                        <Link href={'/dashboard/datalist'} className="m-2 text-center shadow-lg bg-orange rounded-2xl py-2 px-4">Data</Link>
                        <Link href={'/dashboard/userlist'} className="m-2 text-center border rounded-2xl py-2 px-4">Account</Link>
                    </ul>
                </div>
                {/* Bagian 70% */}
