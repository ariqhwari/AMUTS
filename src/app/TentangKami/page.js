...
const Tentangkami = () => {
    return (
        <section>
            <Navbar />
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 p-10 min-h-full gap-5 bg-hijau3">
                ...
                <div className="maps bg-hijau flex md:w-96 md:h-56 items-center justify-center rounded-xl right-0">
